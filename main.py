...
# --- MACCHINA ---
car = Entity(model='cube', color=color.red, scale=(1.2, 0.6, 2.2), position=(0, 0.3, 0), collider='box')
wheel_positions = [(-0.6, -0.3, 0.8), (0.6, -0.3, 0.8), (-0.6, -0.3, -0.8), (0.6, -0.3, -0.8)]
for wp in wheel_positions:
    Entity(model='cube', color=color.black, scale=(0.3, 0.3, 0.3), position=car.position + Vec3(*wp), parent=car)
...
def update():
    global car_speed, current_checkpoint, time_left, game_over, win
